...
- Параллельность: 3–5  
- Задержка: 80–200 мс  
По моему опыту если нужно отсортировать много тикеров на binance, ставим задержку 1000мс и параллельных запросов 1. Тогда вероятность бана мала. У байбита дела обстоят проще. Так как уровней в стакане меньше, можно работать с дефолтными настройками.
---
