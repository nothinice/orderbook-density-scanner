...
Это временная блокировка IP за слишком частые запросы.  
Сканер автоматически остановится и покажет время бана.  
Рекомендации:
- Параллельность: 1–2  
- Задержка: 200–500 мс  
- Использовать WebSocket для live-данных, если нужен частый апдейт  
